	              ...
	              (setq
		              ...
		              (progn
		                ...
		                (cond
		                 ((= char ? )
                    nil)
                                        ; accept word this time only
		                 ((= char ?i)
                                        ; accept and insert word into pers dict
                    ...
                    (when flyspell-mode
                      ...
                      (flyspell-unhighlight-at start))
		                  ...
		                  (if (= char ?A)
                        0))
                                        ; return 0 for ispell-add buffer-local
		                 ((or (= char ?r)
                        (= char ?R))
                                        ; type in replacement
		                 ...
		                 ((= char ?l)
		                  ...
		                  (and (eq 'block ispell-highlight-p)
			                      (ispell-highlight-spelling-error start end nil
							                                                   'block))
		                  t)
                                        ; reselect from new choices
		                 ((= char ?u)
                                        ; insert lowercase into dictionary
